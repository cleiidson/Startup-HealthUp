...
@Composable
fun ComentariosList2(navController: NavController) {
    // Lista de comentários com nome e mensagem
    val comentarios = listOf(
        Comentario("Laura", stringResource(R.string.comment_laura)),
        Comentario("José", stringResource(R.string.coments_jose)),
...
@Composable
fun ComentarioItem2(comentario: Comentario) {
    Card(
        modifier = Modifier
            .fillMaxWidth()
            .padding(8.dp),
...
data class Comentario2(val author: String, val message: String)
