...
@Composable
fun Memory3(navController: NavController) {
    Box(
        modifier = Modifier
            .fillMaxSize()
    ) {
        ...
        )
        {
            ...
            // Dica 5: Técnicas de Concentração
            Text(
                text = stringResource(id = R.string.atividadeConcentracao),
                fontSize = 16.sp,
                fontWeight = FontWeight.Bold,
                color = Color.Black
            )
            Text(
                text = stringResource(id = R.string.tecnicasConcentracaoTexto),
                fontSize = 14.sp,
                color = Color.Gray
            )
