...
@Composable
fun Diets2(navController: NavController) {
    Box(modifier = Modifier.fillMaxSize()) {
        Column(
                ...
                Row(
                    ...
                    Image(
                        ...
                        modifier = Modifier
                            ...
                            .size(34.dp)
                            .padding(start = 10.dp)
                            .clickable { navController.navigate("diets") }
                    )
            ...
            val categoryPescetarian = stringResource(id = R.string.Pescatarian_DietCategory)
            val categoryDash = stringResource(id = R.string.Dash_DietCategory)
            val categoryVegetarian = stringResource(id = R.string.Vegetarian_DietCategory)

            Category4(categoryPescetarian, R.drawable.dietapescetariana) {
                // criar uma tela cheia de dicas de dietas especificas
            }
            Spacer(modifier = Modifier.height(18.dp))
            Category4(categoryDash, R.drawable.dietadash) {
                // criar uma tela cheia de dicas de dietas especificas
            }
            Spacer(modifier = Modifier.height(18.dp))
            Category4(categoryVegetarian, R.drawable.dietavegetariana) {
                // criar uma tela cheia de dicas de dietas especificas
            }
        }
    }
...
@Composable
fun Category4(category: String, backgroundResId: Int, onClick: () -> Unit) {
    Box(
        modifier = Modifier
            .fillMaxWidth()
            .height(173.dp)
