...
@Composable
fun Cardiology(navController: NavController) {
...
//                )
            ...
            val categoryPressaoArterial = stringResource(id = R.string.categoryPressaoArterial)
            val categoryPrevinirInfarto = stringResource(id = R.string.categoryPrevinirInfarto)
            val categoryIdentificarInfarto = stringResource(id = R.string.categoryIdentificarInfarto)


            Category5(categoryPressaoArterial, R.drawable.pressaoarterial) {
                 //criar uma tela para mostrar a pressão arterial
            }
            Spacer(modifier = Modifier.height(18.dp))

            Category5(categoryPrevinirInfarto, R.drawable.previnirinfarto) {
                 //criar uma tela cheia de dicas de previnir infarto
            }
            Spacer(modifier = Modifier.height(18.dp))

            Category5(categoryIdentificarInfarto, R.drawable.identificarinfarto) {
                //criar uma tela cheia de dicas de identificar infarto
            }
...
@Composable
fun Category5(category: String, backgroundResId: Int, onClick: () -> Unit) {
    Box(
        modifier = Modifier
            .fillMaxWidth()
            .height(173.dp)
