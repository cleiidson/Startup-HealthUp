...
@Composable
fun Memory(navController: NavController) {
    Box(
        modifier = Modifier
            .fillMaxSize()
    ) {
        ...
        )
        {
            Row(
                ...
                Image(
                    ...
                    modifier = Modifier
                        ...
                        .size(34.dp)
                        .padding(end = 10.dp)
                        .clickable { navController.navigate("memory2") }
                )
            ...
            Column(
                ...
                // Dica 1: Exercícios de Relaxamento
                Text(
                    text = stringResource(id = R.string.exercicioRelaxamento),
                    fontSize = 16.sp,
                    fontWeight = FontWeight.Bold,
                    color = Color.Black
                )
                Text(
                    text = stringResource(id = R.string.exercicioRelaxamentoTexto),
                    fontSize = 14.sp,
                    color = Color.Gray
                )
                Spacer(modifier = Modifier.height(16.dp))

                // Dica 2: Sono de Qualidade
                Text(
                    text = stringResource(id = R.string.sonoQualidade),
                    fontSize = 16.sp,
                    fontWeight = FontWeight.Bold,
                    color = Color.Black
                )
                Text(
                    text = stringResource(id = R.string.rotinaSonoTexto),
                    fontSize = 14.sp,
                    color = Color.Gray
                )
